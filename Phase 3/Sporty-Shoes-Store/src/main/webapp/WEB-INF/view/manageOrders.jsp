							...
							<table style="width: 65%">
								...
								<c:forEach var="order" items="${orders}">
									...
									<tr>
										...
										<td><a href="${deleteLink}" class="btn btn-danger" style="padding: 5px 30px; margin: 10px 0;">
												Delete</a></td>
								...
								<tr>
									<td colspan="4" style="padding: 10px 0">Total Price =<strong>&#8377</strong><strong >${totalPrice}</strong></td>
								</tr>
